    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>()
            {
                  ...
                  new Product(){Id = 9 , Name  ="Sound Bar",Price = 700.0, Category = c3 },
            ...
            // var r5 = r4.Skip(2).Take(4);//pula os 2 primeiros e pega os 4 seguintes
            ...
            Console.WriteLine("Category 1 aggragate sum: "+ r15);
